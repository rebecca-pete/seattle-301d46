...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT //'let rando' was declared locally. When line 38 tried to console log 'let rando' outside of the while loop, it didn't exist.
  console.log(viewed);
